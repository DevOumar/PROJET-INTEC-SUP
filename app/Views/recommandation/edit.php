...
<?= $this->section('title') ?>
Mise à jour de <?= strtoupper($recommandation->nom_livre) ?>
<?= $this->endSection() ?>
<?= $this->section('pageTitle') ?>
<?= strtoupper($recommandation->nom_livre) ?>
<?= $this->endSection() ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="nom_livre" name="nom_livre"
                                    value="<?= $recommandation->nom_livre ?>" type="text">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="nom_auteur" name="nom_auteur"
                                    value="<?= $recommandation->nom_auteur ?>" type="text">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group has-feedback">
                                ...
                                <textarea name="description" id="description" class="form-control"
                                    required><?= $recommandation->description ?></textarea>

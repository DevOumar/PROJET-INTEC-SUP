...
Espace Professeurs <a href="<?= base_url('user/professeur') ?>" class="btn btn-rounded btn-primary btn-sm"><i
...
<li><i class="fa fa-angle-right"></i> espace Professeurs</li>
<?= $this->endSection() ?>

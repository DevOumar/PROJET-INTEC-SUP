...
Tous les emprunts retournés <a href="<?= base_url('emprunts/retournes') ?>" class="btn btn-primary btn-sm"><i
...
<li><i class="fa fa-angle-right"></i> tous les emprunts retournés</li>
<?= $this->endSection(); ?>
            ...
            <tbody>
                <?php foreach ($emprunts as $key => $emprunt): ?>
                    <tr>
                        ...
                        <td>
                            <span style="font-size: smaller;" class="btn btn-rounded btn-danger btn-sm">
                                <?= date('d/m/Y', strtotime($emprunt->delai_retour)) ?>
                            </span>
                        </td>
                        <td>
                            <span style="font-size: smaller;" class="btn btn-rounded btn-primary btn-sm">
